...
body {
    ...
    rgba(204, 0, 0, 0.8),
    rgba(204, 0, 0, 0) 70.71%),
    linear-gradient(127deg,
    rgba(51, 204, 0, 0.8),
    rgba(51, 204, 0, 0) 70.71%),
...
.r1-1 {
    text-shadow: rgb(163, 82, 0) 1px 1px;
}
.overview-box {
    text-shadow: rgb(163, 82, 0) 1px 1px;
}
#Badge {
    ...
    text-shadow: rgb(163, 82, 0) 1px 1px;
    background-image: linear-gradient(rgb(69, 74, 77),
    rgb(55, 60, 62));
    background-color: initial;
}
#Badge:hover {
    background-image: linear-gradient(rgb(55, 60, 62),
    rgb(69, 74, 77));
    background-color: initial;
}
.goBack {
